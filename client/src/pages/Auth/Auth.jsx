      ...
      <div className='auth-container-2'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor="password">
            ...
            {isSignup && <p style={{color:'#666767', fontSize:'13px' }}>Passwords must contain at least<br/> eight characters, including at least 1 letter and 1 <br/>number.</p>}
            ...
            {isSignup && (
              <label htmlFor='check'>
                ...
                <p style={{fontSize:'13px'}}>Opt-in to recieve occasional<br/>product updates, user research invitations,<br/> company announcements, and digest</p>
              </label>
            )}
